...
function HeaderInner() {
  ...
  return (
    <header className="w-full h-12 xl:h-16 exl:h-24 p-2 xl:p-6 flex justify-between items-center">
      <Link href={homeHref} title="Início">
...
/** Suspense por causa de useSearchParams (preserva ?deviceId= no link Início). */
const Header = () => (
  <Suspense fallback={<header className="w-full h-12 xl:h-16 exl:h-24 p-2 xl:p-6" />}>
    <HeaderInner />
  </Suspense>
);
